...
class DetailPaketKasir extends StatefulWidget {
  DetailPaketKasir(
    this.itemId, {
    super.key,
  }) {
  ...
  @override
  State<DetailPaketKasir> createState() => _DetailPaketKasirState();
}

class _DetailPaketKasirState extends State<DetailPaketKasir> {
